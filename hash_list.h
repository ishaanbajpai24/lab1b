...
public:
    ...
    /**-----------------------------------------------------------------------------------
     * NOTE: Don't implement the copy constructor or the assignment operator for this lab
     * You'll be implementing them in a future lab.
     * 
     * All you need to know for the copy constructor and assignment operator is not to write 
     * any code like the following
     *
     * hash_list y; 
     * hash_list x(y); -> Don't write this
     * x = y           -> Don't write this
     * 
     *------------------------------------------------------------------------------------
     */
